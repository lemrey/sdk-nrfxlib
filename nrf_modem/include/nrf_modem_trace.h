 ...
 *
 * @param[out] frag Pointer to an array of trace data fragments.
 * @param[out] nfrag Pointer to the number of fragments in the array.
 *
 * @retval 0 on success.
 * @retval -NRF_FAULT If @c frag or @c nfrag is NULL.
